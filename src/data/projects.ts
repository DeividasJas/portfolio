...
function resolveImages(images: { src: string | StaticImageData; alt: string }[]): ImageType[] {
  return images.map((img) => ({ src: resolveImageSrc(img.src), alt: img.alt }))
}
...
export const projects: WebsiteProjectType[] = [
  {
    ...
    published: true,
    logoSrc: resolveImageSrc(basketballAssets.logo),
    images: resolveImages([
      { src: basketballAssets.basketball1, alt: 'BasketJoin About Page' },
      { src: basketballAssets.basketball2, alt: 'BasketJoin Schedule Page' },
      { src: basketballAssets.basketball3, alt: 'BasketJoin Login Page' },
      { src: basketballAssets.basketball4, alt: 'BasketJoin Player Status Page' },
      { src: basketballAssets.basketball5, alt: 'BasketJoin Profile Dashboard' },
      { src: basketballAssets.basketball6, alt: 'BasketJoin Player Status Page' }
    ]),
    projectDescription:
...

  {
    ...
    published: true,
    logoSrc: resolveImageSrc(sweetsecretsAssets.logoMonochrome),
    images: [],
    projectDescription:
    ...
    stack: ['nextjs', 'tailwind', 'supabase', 'claude', 'vercel'],
    highlightKeywords: ['personalized AI-generated romance story']
  },
  {
    title: 'Fametonic',
    slug: 'fametonic',
  ...
  },
  {
    ...
    published: false,
    logoSrc: resolveImageSrc(wanderVilniusAssets.logo),
    images: [],
    projectDescription:
